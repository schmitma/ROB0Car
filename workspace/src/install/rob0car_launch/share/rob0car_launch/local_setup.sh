...
: ${AMENT_CURRENT_PREFIX:="/home/mexx/ROB0Car/workspace/src/install/rob0car_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rob0car_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/rob0car_launch/environment/path.sh"
